...
authority_score_file = open("precomputed_scores/authority_score_1", 'w')
hub_score_file = open("precomputed_scores/hubs_score_1", 'w')
...
def get_webgraph_inlinks():
    inlinks_file = open("/Users/chaya/Documents/apache-nutch-1.19/dumps/part-r-00000", 'r', encoding='utf-8').readlines()
